...
class InvitedAdapter(arrayList: ArrayList<InvitedDataClass>, mcontext: InvitationActivity) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_layout_invited_frag, parent, false)
        return RecyclerViewHolder(view)
    }

    override fun onBindViewHolder(holder: RecyclerViewHolder, position: Int) {
        val InvitedDataClass = arrayList[position]

        // getting all vales and storing in val...
        // now setted to the textview
        holder.tvCheckinName.text = InvitedDataClass.opinionTitle
        holder.tvCheckinDate.text = InvitedDataClass.opinionDate
//        holder.imgplace.text = InvitedDataClass.imageUrl
